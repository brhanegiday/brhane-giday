      ...
      <div className=" grid grid-cols-1 sm:grid-cols-2 items-center">
        <div className="text-gray-900 py-6 mb-4 md:pb-0 md:mb-0">
          ...
          <div className="flex space-x-1 items-baseline justify-center sm:justify-start">
            <h2 className="text-2xl md:text-4xl bg-clip-text text-transparent bg-gradient-to-r from-[#FF002B]  to-[#16ADFE] font-semibold ">
              Brhane Giday
            </h2>
          ...
          >
            <button
              ...
              className="flex mx-auto sm:mx-0 group space-x-1 items-center shadow-md rounded-full hover:bg-lochmara-500 border-b-4 border-t-[1px] border-lochmara-500 py-2 px-5 mt-2 hover:translate-x-1 transition transform ease-in-out duration-350"
            >
              <div className="uppercase text-xs font-bold text-lochmara-500 group-hover:text-white">
                View my Work
              </div>
              <div>
                {mouseEvent ? (
                  <ArrowDownIcon
                    role="arrowDown"
                    className="w-8 h-4 text-lochmara-500 group-hover:text-white"
                  />
                ) : (
                  <ArrowRightIcon
                    role="arrowRight"
