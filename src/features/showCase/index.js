...
function Works() {
  return (
    <div className="py-5 mx-auto 2xl:container px-8 md:px-20" id="my-work">
      ...
      <p className="pt-3 md:text-center text-gray-700 text-sm w-full lg:w-3/5 mx-auto">
      ...
      <p className="py-3 md:text-center text-sm text-gray-700">
        These are some of the projects I have worked and participated.
      </p>
